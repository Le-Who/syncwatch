        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="group/volume relative flex items-center space-x-3">
              ...
              <div className="bg-theme-bg border-theme-border/30 rounded-theme relative h-2 w-0 overflow-hidden border transition-all duration-300 group-focus-within/volume:w-24 group-focus-within/volume:overflow-visible group-hover/volume:w-24">
                <div
