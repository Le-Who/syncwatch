...
const PlaylistItem = React.memo(function PlaylistItem({ item, isActive, playback, canEdit, handlePlay, handleRemove }: any) {
          ...
          >
            {room.playlist.map((item) => (
              <PlaylistItem
                ...
                playback={room.currentMediaId === item.id ? room.playback : undefined}
                canEdit={canEdit}
