    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="border-theme-border/30 bg-theme-bg/50 flex items-center justify-between border-b-2 p-5">
          <h2
            id="dialog-title"
            className="text-theme-text text-lg font-bold tracking-wide drop-shadow-sm"
          >
            Terminal Settings
          </h2>
          <button
            ...
            <div className="border-theme-border/30 border-t-2 pt-6">
              <div className="rounded-theme bg-theme-accent/10 border-theme-accent/30 flex items-center justify-between border p-4">
                ...
                <button
                  ...
                  className="bg-theme-accent text-theme-bg rounded-theme ring-theme-accent focus-visible:ring-offset-theme-bg px-4 py-2 text-xs font-bold tracking-widest shadow-[var(--theme-shadow)] transition-all outline-none hover:shadow-[var(--theme-shadow-hover)] focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-0.5 active:shadow-none"
                >
                  CLAIM HOST
                </button>
              </div>
        ...
        <div className="border-theme-border/30 bg-theme-bg/50 flex justify-end space-x-3 border-t-2 p-5">
          <button
            onClick={onClose}
            className="text-theme-muted hover:text-theme-text hover:bg-theme-bg/50 rounded-theme hover:border-theme-border ring-theme-accent border-2 border-transparent px-5 py-2.5 text-xs font-bold tracking-widest transition-all outline-none focus-visible:ring-2"
          >
            CANCEL
          </button>
          {isOwnerOrMod && (
            <button
              onClick={handleSave}
              className="bg-theme-accent text-theme-bg rounded-theme ring-theme-accent focus-visible:ring-offset-theme-bg flex items-center space-x-2 px-5 py-2.5 text-xs font-bold tracking-widest shadow-[var(--theme-shadow)] transition-all outline-none hover:shadow-[var(--theme-shadow-hover)] focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-0.5 active:shadow-none"
            >
