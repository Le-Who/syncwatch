      ...
      >
        ...
        <div className="border-theme-border/30 bg-theme-bg/50 flex justify-end space-x-3 border-t-2 p-5">
          ...
          {isOwnerOrMod && (
            <button
              onClick={handleSave}
              className="bg-theme-accent text-theme-bg rounded-theme ring-theme-accent flex items-center space-x-2 px-5 py-2.5 text-xs font-bold tracking-widest shadow-[var(--theme-shadow)] transition-all hover:shadow-[var(--theme-shadow-hover)] active:translate-y-0.5 active:shadow-none outline-none focus-visible:ring-2"
            >
